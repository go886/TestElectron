...
TNodeService.register('alert', (args, callback)=>{

});

TNodeService.invoke('mtop://send?method=xxxx&args=xxx', null, (res) => {

});

TNodeService.$alert({title:'xxxx'}, (res)=>{
